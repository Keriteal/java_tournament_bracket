...
public class MatchController {
    ...
    public ResponseEntity<CreateTournamentResponseDTO> createTournament(@ApiParam("UserName") @RequestHeader(value = "User-Name", required = false) String userName,
                                                                        @RequestBody @Valid CreateTournamentRequestDTO request)
            throws InvalidTeamCountException, FormatNotSupportException, InvalidUserHeaderException {
